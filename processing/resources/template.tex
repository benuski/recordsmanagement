% Set metadata variables from Pandoc
\setvariable{metadata}{agency}{$if(agency)$$agency$$else$Retention Schedule$endif$}
\setvariable{metadata}{id}{$if(id)$$id$$endif$}

$if(tagging)$
\setupbackend[format=pdf/ua-4]
